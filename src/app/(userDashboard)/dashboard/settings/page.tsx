          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked) =>
                  handleSettingChange("privacy", "analyticsOptOut", checked)
                }
              />
            </div>
          </CardContent>
          ...
          <AlertDialog>
            ...
            <AlertDialogContent>
              <AlertDialogHeader>
                ...
                <AlertDialogDescription>
                  This action will deactivate your account. You can reactivate
                  it by logging in again, but some data may be temporarily
                  inaccessible.
                </AlertDialogDescription>
              </AlertDialogHeader>
              <AlertDialogFooter>
