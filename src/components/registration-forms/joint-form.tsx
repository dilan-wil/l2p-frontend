...
export default function JointAccountForm({
  onSubmit,
  isSubmitting,
    ...
    switch (currentStep) {
      case 0: // Account Type
        if (!formData.accountType)
          newErrors.accountType = "Type de compte requis";
        if (!formData.signatureType)
          newErrors.signatureType = "Type de signature requis";
        break;
      case 1: // Holder 1
        if (!formData.holder1Name.trim())
          newErrors.holder1Name = "Nom du cotitulaire 1 requis";
        if (!formData.holder1Phone.trim())
          newErrors.holder1Phone = "Téléphone requis";
        if (!formData.holder1Email.trim())
          newErrors.holder1Email = "Email requis";
        break;
      case 2: // Holder 2
        if (!formData.holder2Name.trim())
          newErrors.holder2Name = "Nom du cotitulaire 2 requis";
        if (!formData.holder2Phone.trim())
          newErrors.holder2Phone = "Téléphone requis";
        if (!formData.holder2Email.trim())
          newErrors.holder2Email = "Email requis";
        break;
      case 4: // Signatures
        if (!formData.declaration)
          newErrors.declaration = "Déclaration requise";
        if (!formData.terms1Accepted)
          newErrors.terms1Accepted = "Acceptation des conditions requise";
        if (!formData.terms2Accepted)
          newErrors.terms2Accepted = "Acceptation des conditions requise";
        break;
    }
        ...
        <div className="space-y-4">
          <div>
            ...
            >
              ...
              <SelectContent>
                <SelectItem value="joint-or">
                  {t("jointAccountTypes.jointOr")}
                </SelectItem>
                <SelectItem value="joint-and">
                  {t("jointAccountTypes.jointAnd")}
                </SelectItem>
              </SelectContent>
            </Select>
            {errors.accountType && (
          ...
          <div>
            ...
            >
              <SelectTrigger
                className={errors.signatureType ? "border-destructive" : ""}
              >
                <SelectValue placeholder={g("common.select")} />
              </SelectTrigger>
              <SelectContent>
                <SelectItem value="individual">
                  {t("signatureTypes.individual")}
                </SelectItem>
                <SelectItem value="joint">
                  {t("signatureTypes.joint")}
                </SelectItem>
              </SelectContent>
            </Select>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <Input
              ...
              onChange={(e) =>
                handleInputChange("holder1Phone", e.target.value)
              }
          ...
          <div>
            ...
            <Input
              ...
              onChange={(e) =>
                handleInputChange("holder1Email", e.target.value)
              }
          ...
          <div className="md:col-span-2">
            ...
            <Input
              ...
              onChange={(e) =>
                handleInputChange("holder1Address", e.target.value)
              }
            />
          </div>

          <div>
            <Label htmlFor="holder1Profession">
              {t("fields.holder1Profession")}
            </Label>
            <Input
              id="holder1Profession"
              value={formData.holder1Profession}
              onChange={(e) =>
                handleInputChange("holder1Profession", e.target.value)
              }
            />
          </div>

          <div>
            <Label htmlFor="holder1Employer">
              {t("fields.holder1Employer")}
            </Label>
            <Input
              id="holder1Employer"
              value={formData.holder1Employer}
              onChange={(e) =>
                handleInputChange("holder1Employer", e.target.value)
              }
            />
          </div>

          <div>
            <Label htmlFor="holder1IdNumber">
              {t("fields.holder1IdNumber")}
            </Label>
            <Input
              id="holder1IdNumber"
              value={formData.holder1IdNumber}
              onChange={(e) =>
                handleInputChange("holder1IdNumber", e.target.value)
              }
            />
          </div>

          <div>
            <Label htmlFor="holder1IdIssuer">
              {t("fields.holder1IdIssuer")}
            </Label>
            <Input
              id="holder1IdIssuer"
              value={formData.holder1IdIssuer}
              onChange={(e) =>
                handleInputChange("holder1IdIssuer", e.target.value)
              }
            />
          </div>
          ...
          <div>
            ...
            <Input
              ...
              onChange={(e) =>
                handleInputChange("holder1IdDate", e.target.value)
              }
            />
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <Input
              ...
              onChange={(e) =>
                handleInputChange("holder2Phone", e.target.value)
              }
          ...
          <div>
            ...
            <Input
              ...
              onChange={(e) =>
                handleInputChange("holder2Email", e.target.value)
              }
          ...
          <div className="md:col-span-2">
            ...
            <Input
              ...
              onChange={(e) =>
                handleInputChange("holder2Address", e.target.value)
              }
            />
          </div>

          <div>
            <Label htmlFor="holder2Profession">
              {t("fields.holder2Profession")}
            </Label>
            <Input
              id="holder2Profession"
              value={formData.holder2Profession}
              onChange={(e) =>
                handleInputChange("holder2Profession", e.target.value)
              }
            />
          </div>

          <div>
            <Label htmlFor="holder2Employer">
              {t("fields.holder2Employer")}
            </Label>
            <Input
              id="holder2Employer"
              value={formData.holder2Employer}
              onChange={(e) =>
                handleInputChange("holder2Employer", e.target.value)
              }
            />
          </div>

          <div>
            <Label htmlFor="holder2IdNumber">
              {t("fields.holder2IdNumber")}
            </Label>
            <Input
              id="holder2IdNumber"
              value={formData.holder2IdNumber}
              onChange={(e) =>
                handleInputChange("holder2IdNumber", e.target.value)
              }
            />
          </div>

          <div>
            <Label htmlFor="holder2IdIssuer">
              {t("fields.holder2IdIssuer")}
            </Label>
            <Input
              id="holder2IdIssuer"
              value={formData.holder2IdIssuer}
              onChange={(e) =>
                handleInputChange("holder2IdIssuer", e.target.value)
              }
            />
          </div>
          ...
          <div>
            ...
            <Input
              ...
              onChange={(e) =>
                handleInputChange("holder2IdDate", e.target.value)
              }
            />
          </div>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            <div className="flex items-center space-x-2">
              ...
              />
              <Label htmlFor="jointAccountEpargne">
            ...
            <div className="flex items-center space-x-2">
              ...
              />
              <Label htmlFor="jointAccountCourant">
            ...
            <div className="flex items-center space-x-2">
              ...
              />
              <Label htmlFor="jointAccountNDjangui">
            ...
            <div className="flex items-center space-x-2">
              ...
              />
              <Label htmlFor="jointAccountCheque">
                {t("accountTypes.cheque")}
              </Label>
            </div>
            ...
            <div className="flex items-center space-x-2">
              ...
              />
              <Label htmlFor="jointAccountPlacement">
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center space-x-2">
              <Checkbox
                ...
                onCheckedChange={(checked) =>
                  handleInputChange("terms1Accepted", checked as boolean)
                }
              />
            ...
            <div className="flex items-center space-x-2">
              <Checkbox
                ...
                onCheckedChange={(checked) =>
                  handleInputChange("terms2Accepted", checked as boolean)
                }
              />
